import{a as x,t as A}from"./CN_XHGqh.js";import"./CKrklXwb.js";import{X as N,f as G,g as n,s as t,Z as w,c as l,r as o,I as v,t as $,a0 as B,a1 as f,a2 as R}from"./D1dJn-AD.js";import{r as g}from"./DX_m2Chg.js";import{s as S}from"./PwPRnE0L.js";import{b as _}from"./0EC-kKHt.js";import{b as L}from"./Yeeob5TE.js";import{p as F,s as z}from"./MZmv_OPH.js";import{F as k,a as H,b as I,L as b,c as P,E as X}from"./C1apKSBE.js";var Z=A("<strong><!></strong> <p><!></p>",1);function j(h,s){N(s,!0);let E=F(s,"userName",3,"Anna"),r=F(s,"userGender",3,"female"),a=F(s,"photoCount",3,3);const c=`
...
`,D=new k("en");D.addResource(new H(c)),I(()=>P([D]));var p=Z(),e=G(p),y=l(e);const C=v(()=>({userName:E()}));b(y,{id:"hello-user",get args(){return n(C)}}),o(e);var i=t(e,2),d=l(i);const m=v(()=>({userName:E(),userGender:r(),photoCount:a()}));b(d,{id:"shared-photos",get args(){return n(m)}}),o(i),x(h,p),w()}const q=`<pre class="shiki dark-plus" style="background-color:#1E1E1E;color:#D4D4D4" tabindex="0"><code><span class="line"><span style="color:#808080">&#x3C;</span><span style="color:#569CD6">script</span><span style="color:#808080">></span></span>
...
<span class="line"><span style="color:#808080">&#x3C;/</span><span style="color:#569CD6">p</span><span style="color:#808080">></span></span>
<span class="line"></span></code></pre>`;var J=A('<dl><dt><label for="frontpage-username">userName</label></dt> <dd><input id="frontpage-username" type="text"></dd> <dt><label for="frontpage-usergender">userGender</label></dt> <dd><select id="frontpage-usergender"><option>male</option><option>female</option><option>unspecified</option></select></dd> <dt><label for="frontpage-photocount">photoCount</label></dt> <dd><input id="frontpage-photocount" type="range" min="1" max="9"></dd></dl>');function ss(h){const s=B({userName:"Anna",userGender:"female",photoCount:3});X(h,{sources:{"App.svelte":{code:q,html:!0}},controls:r=>{var a=J();S(a,"--space","var(--s-2)");var c=t(l(a),2),D=l(c);g(D),o(c);var p=t(c,4),e=l(p);$(()=>{n(s),R(()=>{})});var y=l(e);y.value=(y.__value="male")==null?"":"male";var C=t(y);C.value=(C.__value="female")==null?"":"female";var i=t(C);i.value=(i.__value="unspecified")==null?"":"unspecified",o(e),o(p);var d=t(p,4),m=l(d);g(m),o(d),o(a),_(D,()=>n(s).userName,u=>f(s,n(s).userName=u)),L(e,()=>n(s).userGender,u=>f(s,n(s).userGender=u)),_(m,()=>n(s).photoCount,u=>f(s,n(s).photoCount=u)),x(r,a)},children:(r,a)=>{j(r,z(()=>n(s)))},$$slots:{controls:!0,default:!0}})}export{ss as F};
