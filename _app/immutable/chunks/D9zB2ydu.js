import{f as A,a as N}from"./DPZc8XSh.js";import"./C2pXhadt.js";import{p as $,f as G,c as l,g as n,ad as g,r as o,s as c,a as w,ae as B,X as R,t as S,af as L,ag as E}from"./DGZvizoz.js";import{a as z,r as _,b as k}from"./BD5HoqOc.js";import{b}from"./FwAaUVum.js";import{p as f,s as H}from"./Cp4LbrTJ.js";import{F as q,a as P,i as X,c as j,L as x,E as I}from"./BBVgH7AR.js";var J=A("<strong><!></strong> <p><!></p>",1);function K(m,s){$(s,!0);let d=f(s,"userName",3,"Anna"),h=f(s,"userGender",3,"female"),D=f(s,"photoCount",3,3);const a=`
...
<span class="line"><span style="color:#808080">&#x3C;/</span><span style="color:#569CD6">p</span><span style="color:#808080">></span></span>
<span class="line"></span></code></pre>`;var O=A('<dl><dt><label for="frontpage-username">userName</label></dt> <dd><input id="frontpage-username" type="text"/></dd> <dt><label for="frontpage-usergender">userGender</label></dt> <dd><select id="frontpage-usergender"><option>male</option><option>female</option><option>unspecified</option></select></dd> <dt><label for="frontpage-photocount">photoCount</label></dt> <dd><input id="frontpage-photocount" type="range" min="1" max="9"/></dd></dl>');function ss(m){const s=B({userName:"Anna",userGender:"female",photoCount:3});{const d=D=>{var a=O();z(a,"",{},{"--space":"var(--s-2)"});var p=c(l(a),2),y=l(p);_(y),o(p);var e=c(p,4),C=l(e);S(()=>{n(s),L(()=>{})});var t=l(C);t.value=t.__value="male";var i=c(t);i.value=i.__value="female";var r=c(i);r.value=r.__value="unspecified",o(C),o(e);var F=c(e,4),v=l(F);_(v),o(F),o(a),b(y,()=>n(s).userName,u=>E(s,n(s).userName=u)),k(C,()=>n(s).userGender,u=>E(s,n(s).userGender=u)),b(v,()=>n(s).photoCount,u=>E(s,n(s).photoCount=u)),N(D,a)};let h=R(()=>({"App.svelte":{code:M,html:!0}}));I(m,{get sources(){return n(h)},controls:d,children:(D,a)=>{K(D,H(()=>n(s)))},$$slots:{controls:!0,default:!0}})}}export{ss as F};
