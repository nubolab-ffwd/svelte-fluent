import{f as x,a as N}from"./DPZc8XSh.js";import"./C2pXhadt.js";import{p as $,f as G,c as l,g as n,ad as g,r as o,s as c,a as w,ae as B,X as R,t as S,af as L,ag as h}from"./DGZvizoz.js";import{a as z,r as _,b as k}from"./BD5HoqOc.js";import{b}from"./FwAaUVum.js";import{p as f,s as H}from"./Cp4LbrTJ.js";import{F as q,a as P,i as X,c as j,L as A,E as I}from"./BBVgH7AR.js";var J=x("<strong><!></strong> <p><!></p>",1);function K(m,s){$(s,!0);let d=f(s,"userName",3,"Anna"),E=f(s,"userGender",3,"female"),D=f(s,"photoCount",3,3);const a=`
...
`,p=new q("en");p.addResource(new P(a)),X(()=>j([p]));var y=J(),e=G(y),C=l(e);{let r=g(()=>({userName:d()}));A(C,{id:"hello-user",get args(){return n(r)}})}o(e);var t=c(e,2),i=l(t);{let r=g(()=>({userName:d(),userGender:E(),photoCount:D()}));A(i,{id:"shared-photos",get args(){return n(r)}})}o(t),N(m,y),w()}const M=`<pre class="shiki dark-plus" style="background-color:#1E1E1E;color:#D4D4D4" tabindex="0"><code><span class="line"><span style="color:#808080">&#x3C;</span><span style="color:#569CD6">script</span><span style="color:#808080">></span></span>
<span class="line"><span style="color:#CE92A4">	import</span><span style="color:#D4D4D4"> { </span><span style="color:#9CDCFE">FluentBundle</span><span style="color:#D4D4D4">, </span><span style="color:#9CDCFE">FluentResource</span><span style="color:#D4D4D4"> } </span><span style="color:#CE92A4">from</span><span style="color:#CE9178"> '@fluent/bundle'</span><span style="color:#D4D4D4">;</span></span>
<span class="line"><span style="color:#CE92A4">	import</span><span style="color:#D4D4D4"> { </span><span style="color:#9CDCFE">createSvelteFluent</span><span style="color:#D4D4D4">, </span><span style="color:#9CDCFE">initFluentContext</span><span style="color:#D4D4D4">, </span><span style="color:#9CDCFE">Localized</span><span style="color:#D4D4D4"> } </span><span style="color:#CE92A4">from</span><span style="color:#CE9178"> '@nubolab-ffwd/svelte-fluent'</span><span style="color:#D4D4D4">;</span></span>
...
<span class="line"><span style="color:#808080">&#x3C;/</span><span style="color:#569CD6">p</span><span style="color:#808080">></span></span>
<span class="line"></span></code></pre>`;var O=x('<dl><dt><label for="frontpage-username">userName</label></dt> <dd><input id="frontpage-username" type="text"/></dd> <dt><label for="frontpage-usergender">userGender</label></dt> <dd><select id="frontpage-usergender"><option>male</option><option>female</option><option>unspecified</option></select></dd> <dt><label for="frontpage-photocount">photoCount</label></dt> <dd><input id="frontpage-photocount" type="range" min="1" max="9"/></dd></dl>');function ss(m){const s=B({userName:"Anna",userGender:"female",photoCount:3});{const d=D=>{var a=O();z(a,"",{},{"--space":"var(--s-2)"});var p=c(l(a),2),y=l(p);_(y),o(p);var e=c(p,4),C=l(e);S(()=>{n(s),L(()=>{})});var t=l(C);t.value=t.__value="male";var i=c(t);i.value=i.__value="female";var r=c(i);r.value=r.__value="unspecified",o(C),o(e);var F=c(e,4),v=l(F);_(v),o(F),o(a),b(y,()=>n(s).userName,u=>h(s,n(s).userName=u)),k(C,()=>n(s).userGender,u=>h(s,n(s).userGender=u)),b(v,()=>n(s).photoCount,u=>h(s,n(s).photoCount=u)),N(D,a)};let E=R(()=>({"App.svelte":{code:M,html:!0}}));I(m,{get sources(){return n(E)},controls:d,children:(D,a)=>{K(D,H(()=>n(s)))},$$slots:{controls:!0,default:!0}})}}export{ss as F};
