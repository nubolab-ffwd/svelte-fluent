import{S as o,b as n,s as m,U as g,e as i,V as f,f as d,n as r,k as h}from"./index.2dafc823.mjs";function p(s){let l,a=`
...
`,c;return{c(){l=new g(!1),c=i(),this.h()},l(t){l=f(t,!1),c=i(),this.h()},h(){l.a=c},m(t,e){l.m(a,t,e),d(t,c,e)},p:r,i:r,o:r,d(t){t&&h(c),t&&l.d()}}}class w extends o{constructor(l){super(),n(this,l,null,p,m,{})}}export{w as L};
