import{f as A,a as N}from"./D4QaK02Q.js";import"./CzvE6TAc.js";import{p as $,f as G,c as l,g as n,ai as g,r as o,s as c,a as w,aj as B,$ as R,ak as E}from"./7b_-Sk4V.js";import{a as S,r as _,b as L}from"./BiLxq9gG.js";import{b}from"./BXAELU1i.js";import{p as f,s as k}from"./Ci0ld4dh.js";import{F as z,a as H,i as j,c as q,L as x,E as P}from"./rz8BzkQV.js";var I=A("<strong><!></strong> <p><!></p>",1);function J(m,s){$(s,!0);let d=f(s,"userName",3,"Anna"),h=f(s,"userGender",3,"female"),D=f(s,"photoCount",3,3);const a=`
...
<span class="line"><span style="color:#808080">&#x3C;/</span><span style="color:#569CD6">p</span><span style="color:#808080">></span></span>
<span class="line"></span></code></pre>`;var M=A('<dl><dt><label for="frontpage-username">userName</label></dt> <dd><input id="frontpage-username" type="text"/></dd> <dt><label for="frontpage-usergender">userGender</label></dt> <dd><select id="frontpage-usergender"><option>male</option><option>female</option><option>unspecified</option></select></dd> <dt><label for="frontpage-photocount">photoCount</label></dt> <dd><input id="frontpage-photocount" type="range" min="1" max="9"/></dd></dl>');function Y(m){const s=B({userName:"Anna",userGender:"female",photoCount:3});{const d=D=>{var a=M();S(a,"",{},{"--space":"var(--s-2)"});var p=c(l(a),2),y=l(p);_(y),o(p);var e=c(p,4),C=l(e),t=l(C);t.value=t.__value="male";var i=c(t);i.value=i.__value="female";var r=c(i);r.value=r.__value="unspecified",o(C),o(e);var F=c(e,4),v=l(F);_(v),o(F),o(a),b(y,()=>n(s).userName,u=>E(s,n(s).userName=u)),L(C,()=>n(s).userGender,u=>E(s,n(s).userGender=u)),b(v,()=>n(s).photoCount,u=>E(s,n(s).photoCount=u)),N(D,a)};let h=R(()=>({"App.svelte":{code:K,html:!0}}));P(m,{get sources(){return n(h)},controls:d,children:(D,a)=>{J(D,k(()=>n(s)))},$$slots:{controls:!0,default:!0}})}}export{Y as F};
