import{f as x,a as N}from"./BDj5WMAP.js";import"./D4MNzJAD.js";import{p as $,f as G,c as l,g as n,ad as g,r as o,s as c,a as w,ae as B,a4 as R,t as S,af as L,ag as h}from"./DxQPLIai.js";import{a as z,r as _,b as k}from"./eptXwEMs.js";import{b}from"./CoSME50H.js";import{p as f,s as H}from"./ny-SpDL7.js";import{F as q,a as P,i as j,c as I,L as A,E as J}from"./Cc8I-E7s.js";var K=x("<strong><!></strong> <p><!></p>",1);function M(m,s){$(s,!0);let d=f(s,"userName",3,"Anna"),E=f(s,"userGender",3,"female"),D=f(s,"photoCount",3,3);const a=`
...
<span class="line"><span style="color:#808080">&#x3C;/</span><span style="color:#569CD6">p</span><span style="color:#808080">></span></span>
<span class="line"></span></code></pre>`;var Q=x('<dl><dt><label for="frontpage-username">userName</label></dt> <dd><input id="frontpage-username" type="text"/></dd> <dt><label for="frontpage-usergender">userGender</label></dt> <dd><select id="frontpage-usergender"><option>male</option><option>female</option><option>unspecified</option></select></dd> <dt><label for="frontpage-photocount">photoCount</label></dt> <dd><input id="frontpage-photocount" type="range" min="1" max="9"/></dd></dl>');function ss(m){const s=B({userName:"Anna",userGender:"female",photoCount:3});{const d=D=>{var a=Q();z(a,"",{},{"--space":"var(--s-2)"});var p=c(l(a),2),y=l(p);_(y),o(p);var e=c(p,4),C=l(e);S(()=>{n(s),L(()=>{})});var t=l(C);t.value=t.__value="male";var i=c(t);i.value=i.__value="female";var r=c(i);r.value=r.__value="unspecified",o(C),o(e);var F=c(e,4),v=l(F);_(v),o(F),o(a),b(y,()=>n(s).userName,u=>h(s,n(s).userName=u)),k(C,()=>n(s).userGender,u=>h(s,n(s).userGender=u)),b(v,()=>n(s).photoCount,u=>h(s,n(s).photoCount=u)),N(D,a)};let E=R(()=>({"App.svelte":{code:O,html:!0}}));J(m,{get sources(){return n(E)},controls:d,children:(D,a)=>{M(D,H(()=>n(s)))},$$slots:{controls:!0,default:!0}})}}export{ss as F};
