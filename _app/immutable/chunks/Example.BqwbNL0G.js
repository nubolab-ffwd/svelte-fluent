import{a as x,t as A}from"./disclose-version.B3vtwSbd.js";import{p as N,f as G,g as n,s as t,a as w,c as l,r as o,n as v,t as $,ao as B,ap as R,aq as f}from"./runtime.BG2WyBbu.js";import{r as g}from"./attributes.FMsm8o_4.js";import{s as S}from"./style.PwPRnE0L.js";import{b as _}from"./input.BOj8-wNC.js";import{b as L}from"./select.CXXORJJj.js";import{p as F,s as z}from"./props.mPnHdJQw.js";import{F as k,a as H,b as q,c as P,E as j}from"./Overlay.svelte_svelte_type_style_lang.BaMt7AUn.js";import{L as b}from"./Localized.ZvxhCta9.js";var I=A("<strong><!></strong> <p><!></p>",1);function J(h,s){N(s,!0);let E=F(s,"userName",3,"Anna"),r=F(s,"userGender",3,"female"),a=F(s,"photoCount",3,3);const c=`
...
`,D=new k("en");D.addResource(new H(c)),q(()=>P([D]));var p=I(),e=G(p),y=l(e),C=v(()=>({userName:E()}));b(y,{id:"hello-user",get args(){return n(C)}}),o(e);var i=t(e,2),d=l(i),m=v(()=>({userName:E(),userGender:r(),photoCount:a()}));b(d,{id:"shared-photos",get args(){return n(m)}}),o(i),x(h,p),w()}const K=`<pre class="shiki dark-plus" style="background-color:#1E1E1E;color:#D4D4D4" tabindex="0"><code><span class="line"><span style="color:#808080">&#x3C;</span><span style="color:#569CD6">script</span><span style="color:#808080">></span></span>
