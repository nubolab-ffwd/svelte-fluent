import{S,i as R,s as C,x as F,y,z as L,f as k,t as A,A as D,C as I,k as f,q as u,a as w,l as c,m as d,r as i,h as o,c as _,n as v,X as Sr,b as h,M as l,Y as Er,Z as Rr,_ as Cr}from"../../../../chunks/index-d7ccb192.js";import{F as Ke,a as Me,b as pe,L as me,E as Ne,c as Lr,d as Fr,e as Wn}from"../../../../chunks/Overlay.svelte_svelte_type_style_lang-1a01065c.js";function Tr(s){let e,r;return e=new me({props:{id:"hello"}}),{c(){F(e.$$.fragment)},l(t){y(e.$$.fragment,t)},m(t,a){L(e,t,a),r=!0},p:I,i(t){r||(k(e.$$.fragment,t),r=!0)},o(t){A(e.$$.fragment,t),r=!1},d(t){D(e,t)}}}function Wr(s){let e,r;return e=new Ke({props:{bundles:[s[0]],$$slots:{default:[Tr]},$$scope:{ctx:s}}}),{c(){F(e.$$.fragment)},l(t){y(e.$$.fragment,t)},m(t,a){L(e,t,a),r=!0},p(t,[a]){const p={};a&2&&(p.$$scope={dirty:a,ctx:t}),e.$set(p)},i(t){r||(k(e.$$.fragment,t),r=!0)},o(t){A(e.$$.fragment,t),r=!1},d(t){D(e,t)}}}const Yr="hello = Hello, world!";function Br(s){const e=new Me("en");return e.addResource(new pe(Yr)),[e]}let jr=class extends S{constructor(e){super(),R(this,e,Br,Wr,C,{})}};const Ir=`<script>
...
`;function Hr(s){let e,r;return e=new Ne({props:{sources:{"App.svelte":Ir},component:jr}}),{c(){F(e.$$.fragment)},l(t){y(e.$$.fragment,t)},m(t,a){L(e,t,a),r=!0},p:I,i(t){r||(k(e.$$.fragment,t),r=!0)},o(t){A(e.$$.fragment,t),r=!1},d(t){D(e,t)}}}let Kr=class extends S{constructor(e){super(),R(this,e,null,Hr,C,{})}};const kr=`hello = Hello, world!
`;function Mr(s){let e,r;return e=new me({props:{id:"hello"}}),{c(){F(e.$$.fragment)},l(t){y(e.$$.fragment,t)},m(t,a){L(e,t,a),r=!0},p:I,i(t){r||(k(e.$$.fragment,t),r=!0)},o(t){A(e.$$.fragment,t),r=!1},d(t){D(e,t)}}}function Nr(s){let e,r;return e=new Ke({props:{bundles:[s[0]],$$slots:{default:[Mr]},$$scope:{ctx:s}}}),{c(){F(e.$$.fragment)},l(t){y(e.$$.fragment,t)},m(t,a){L(e,t,a),r=!0},p(t,[a]){const p={};a&4&&(p.$$scope={dirty:a,ctx:t}),e.$set(p)},i(t){r||(k(e.$$.fragment,t),r=!0)},o(t){A(e.$$.fragment,t),r=!1},d(t){D(e,t)}}}function qr(s){const e=new pe(kr),r=new Me("en");return r.addResource(e),[r]}let Ur=class extends S{constructor(e){super(),R(this,e,qr,Nr,C,{})}};const Vr=`<script>
	import { FluentBundle, FluentResource } from '@fluent/bundle';
	import { FluentProvider, Localized } from '@nubolab-ffwd/svelte-fluent';
...
Values for those variables are provided via the `),Xe=f("code"),fn=u("args"),cn=u(" prop of the "),Ze=f("code"),dn=u("Localized"),pn=u(" and "),Ge=f("code"),mn=u("Overlay"),$n=u(" components."),dt=w(),F(Le.$$.fragment),pt=w(),ke=f("h2"),Ce=f("a"),gn=u("Interpolation formatting"),mt=w(),ae=f("p"),hn=u(`Fluent outputs interpolations in a human readable format appropriate to the currently used locale.
...
and replace `),Qe=c(Ie,"CODE",{});var rr=d(Qe);rn=i(rr,"navigator.languages"),rr.forEach(o),ln=i(Ie," with the resulting list of locale identifiers."),Ie.forEach(o),At.forEach(o),it=_(n),y(Fe.$$.fragment,n),ft=_(n),ye=c(n,"H2",{id:!0});var lr=d(ye);Re=c(lr,"A",{href:!0});var or=d(Re);on=i(or,"Interpolation"),or.forEach(o),lr.forEach(o),ct=_(n),P=c(n,"P",{});var U=d(P);an=i(U,`You can insert variables into your translated text by using
`),oe=c(U,"A",{href:!0,rel:!0,target:!0});var ar=d(oe);sn=i(ar,"Fluent Placeables"),ar.forEach(o),un=i(U,`.
Values for those variables are provided via the `),Xe=c(U,"CODE",{});var sr=d(Xe);fn=i(sr,"args"),sr.forEach(o),cn=i(U," prop of the "),Ze=c(U,"CODE",{});var ur=d(Ze);dn=i(ur,"Localized"),ur.forEach(o),pn=i(U," and "),Ge=c(U,"CODE",{});var ir=d(Ge);mn=i(ir,"Overlay"),ir.forEach(o),$n=i(U," components."),U.forEach(o),dt=_(n),y(Le.$$.fragment,n),pt=_(n),ke=c(n,"H2",{id:!0});var fr=d(ke);Ce=c(fr,"A",{href:!0});var cr=d(Ce);gn=i(cr,"Interpolation formatting"),cr.forEach(o),fr.forEach(o),mt=_(n),ae=c(n,"P",{});var xt=d(ae);hn=i(xt,`Fluent outputs interpolations in a human readable format appropriate to the currently used locale.
