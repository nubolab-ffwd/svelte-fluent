<script lang="ts">
	import ExampleRenderer from '$lib/site/ExampleRenderer.svelte';
...
<ExampleRenderer
	...
	componentArgs={args}
>
	<dl slot="controls" style:--space="var(--s-2)">
		...
		<dd>
			<input id="frontpage-photocount" type="range" min="1" max="9" bind:value={args.photoCount} />
		</dd>
	</dl>
</ExampleRenderer>
